...
public class BnBController {
	...
	@Autowired BookingsRepository bookRepo; 
	...
	@ResponseBody
	public ResponseEntity<String> makeBooking(@RequestBody String payload,  @ModelAttribute Bookings booking){
		...
		int duration = jsonObject.getInt("nights");
		...
		System.out.println("this is a booking object " + booking.toString());

		User user = new User(email, name);
		bookRepo.newUser(user);
		try {
